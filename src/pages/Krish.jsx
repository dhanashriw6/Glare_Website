...
const Krish = () => {
  ...
  // Updated to navigate using Krish company route
  const handleButtonClick = (categoryId, categoryName) => {
    navigate(`/companies/krish/category/${categoryId}`, { 
      state: { categoryName, company: "krish" } // Pass company info as state
    });
  };
  
  const [category, setCategories] = useState([]);

  const handleGetCategories = async (company = "krish") => {
    try {
